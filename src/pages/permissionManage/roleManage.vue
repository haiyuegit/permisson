<template>
    <div class="content">
        ...
        <obtn :showRefresh="true" v-on:add="add" v-on:changeStatus="changeStatus" v-on:patchdelete="patchdelete('角色')"></obtn>
        </topWrap>
        <el-table
        ref="permTable"
        v-loading="loading"
...
export default {
    ...
    methods: {
        ...
        async getList(params){
            this.loading = true
            let res = await this.$service.queryRoleManageList(params)
