    ...
    export default {
        ...
        methods: {
            async getList(params){
                ...
                let res = await this.$service.lpffrecordTotalList(req)
            ...
            handleClick(row) {//查看
                ...
                this.$router.push({name: 'LPFFRECORD_DETAILS',query:{activeId:row.activeId, giftClassId:row.giftClassId, activeTopic:row.activeTopic, startTime:row.startTime, endTime:row.endTime, pageNum: 1, pageSize: this.pageSize, timeType: "giveTime",}})
            },
            search(data){
                console.log(data)
