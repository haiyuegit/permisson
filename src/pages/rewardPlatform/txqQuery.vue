    ...
    export default {
        ...
        methods: {
            async getList(params){
                ...
                let res = await this.$service.recordTotalList(req)
            ...
            handleClick(row) {//查看
                ...
                this.$router.push({name: 'TXQRECORD_DETAILS',query:{activeId:row.activeId, activeTopic:row.activeTopic, startTime:row.startTime, endTime:row.endTime, pageNum: 1, pageSize: this.pageSize, timeType: "giveTime",}})
            },
            search(data){
