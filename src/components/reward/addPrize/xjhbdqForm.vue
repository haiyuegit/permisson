<template>
    ...
    <el-form-item v-if="form.raiseInterestTime !== 'CUSTOM'" label="到期期限" prop="raiseInterestTime">
        <el-select v-model="form.raiseInterestTime" placeholder="请选择">
            <el-option
            v-for="(val,key) in selectData.Dqlist"
            :key="key"
    ...
    <el-form-item v-if="form.raiseInterestTime === 'CUSTOM'" label="到期期限" prop="raiseInterestTimeDay">
  ...
  data() {
    ...
    return {
        ...
        rules:{
            ...
            raiseInterestTime: [
                { required: true, message: '请选择到期期限', trigger: 'blur' }
            ],
